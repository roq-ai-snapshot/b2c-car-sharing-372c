  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless car sharing with B2C Car Sharing - Empowering individual customers to book nearby cars, managed proficiently from centralized dashboards by our dedicated operations staff."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1515569067071-ec3b51335dd0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjYXIlMkJyZW50YWx8ZW58MHx8fHwxNjk4MjMyMjI2fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless car sharing with B2C Car Sharing - Empowering individual customers to book nearby cars, managed proficiently from centralized dashboards by our dedicated operations staff.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card
                  userTypeName="Operations Manager"
